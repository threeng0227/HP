...
import { Container, Header, Left, Body, Footer, Button, Icon, Title,Right, Content, Textarea} from 'native-base';
import { ScrollView } from 'react-native-gesture-handler';
import Ionicons from 'react-native-vector-icons/Ionicons';
import Ic from 'react-native-vector-icons/FontAwesome';
import Icons from 'react-native-vector-icons/FontAwesome5';

export default class NextGiftCamera extends Component {
  constructor(props ){
    super(props);
    this.state={
      switch1Value:false,
          ...
          <View style={{width: 340, height: 280,borderRadius:5,borderColor:'#EEEEEE',borderWidth:0.5}}>
                <View style={{flexDirection:'column',  justifyContent: 'center', alignItems: 'center',flex:1}}>
                    ...
                    <View style={{flex:4}}>
                        ...
                        source={require('../Appointments/images/cameralogoHP.png')} 
                            />
                    </View>
                </View>
            </View>
