...
export default class Transferbeing extends Component {
  constructor(props ){
    super(props);
    this.state={
      switch1Value:false,
  ...
  componentDidMount() {
    setTimeout(()=>{this.props.navigation.navigate('TransactionSuccesFull')}, 3000); 
  }
  render() {
    return (
      <Container >
        ...
        <Text style={{fontSize:21,color:'skyblue'}}>Transaction is being made !</Text>
        </View>
