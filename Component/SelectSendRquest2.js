...
import TabContacts from './tabContactManuallyRequest/Contacts.js';
import TabManually from './tabContactManuallyRequest/Manually.js';
import Ionicons from 'react-native-vector-icons/Ionicons';
import Ic from 'react-native-vector-icons/FontAwesome';
import Icons from 'react-native-vector-icons/FontAwesome5';

export default class SelectSendRquest2 extends Component {
        ...
        <Image style={{width:'95%',marginLeft:'2.5%'}}
         ...
         <View style={{marginLeft:'4%',marginRight:'4%'}}>
            <Text style={{fontSize:18,color:'black',marginBottom:'3%'}}>
                Select person to request money
            </Text>
