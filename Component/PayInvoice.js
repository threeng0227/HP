      ...
      <Container >
       <Header style={{ backgroundColor: "white" }}>
           ...
           <Body  style={{justifyContent: "center" ,alignItems:"center",flex:4}}>
               <Text style={{ fontSize: 20,  fontWeight: "bold" }}>Pay Invoice</Text>
           </Body>
        ...
        <View style={{margin:'4%',height:170,borderRadius:4,borderWidth:0.5,borderColor:'#EEEEEE'}}>
        ...
        <View style={{flex:1,justifyContent: 'center',alignItems: 'flex-start'}}>
          ...
          <View style={{flex:1,justifyContent: 'center',alignItems: 'flex-end'}}><Text style={{fontSize:16,color:'black',fontWeight:'bold',flex:1,marginTop:'2%'}}>$ 50.00</Text></View>   
        </View>
        <View style={{justifyContent: 'center',alignItems: 'center',marginRight:'4%',marginLeft:'4%',width:310,borderColor:'#EEEEEE',flexDirection:'row',height:40,flex:1}}>
        <View style={{flex:1,justifyContent: 'center',alignItems: 'flex-start'}}>
            <Text style={{fontSize:15,color:'black',flex:1,marginTop:'4%'}}>Tip:</Text>
         </View>  
          <View style={{flex:1,justifyContent: 'center',alignItems: 'flex-end'}}><Text style={{fontSize:18,color:'black',fontWeight:'bold',flex:1,marginTop:'2%'}}>$ 9.00</Text></View>   
        </View>
        ...
        <View style={{flex:1,marginLeft:'-7%',flexDirection:'row',alignItems:'center'}}><CheckBox style={site.check} checked={this.state.tip}
            onPress={this.tipPressed} />
             <Text style={{fontSize:12,color:'black',paddingLeft:'8%'}}>Use gift card (Value : $ 50):</Text>
            </View>
           
         </View>  
          <View style={{flex:1,justifyContent: 'center',alignItems: 'flex-end'}}><Text style={{fontSize:18,color:'black',fontWeight:'bold',flex:1,marginTop:'2%'}}>{this.state.texttip}</Text></View>   
        </View>
        ...
        <View style={{flex:1,justifyContent: 'center',alignItems: 'flex-start'}}>
          ...
          <View style={{flex:1,justifyContent: 'center',alignItems: 'flex-end'}}><Text style={{fontSize:18,color:'blue',fontWeight:'bold',flex:1,marginTop:'2%'}}>{this.state.texttip1}</Text></View>   
        </View>
        </View>
         ...
         <View style={{marginLeft:'4%',marginRight:'4%',borderRadius:4,borderWidth:0.5,borderColor:'#EEEEEE',paddingTop:'5%',padding:'3%'}}>
            ...
            <View style={{height:47,flexDirection:'row',alignItems:'center',flex:1,justifyContent:'center',marginBottom:'6%'}}>
             ...
             onPress={() =>this.onePressed()}/></View>
                ...
                <View style={{flex:1,marginRight:'-8%',marginTop:'-7%',color:'lightgreen'}}><Text style={{fontSize:13,fontWeight:'bold',color:'lightgreen'}}>$ 100.00</Text></View>
            </View>
        ...
        <View style={site.view}>
          ...
          onPress={()=>{this.props.navigation.navigate('TransactionSend')}}
          ><Text style={site.btn1}> Pay </Text></Button> 
       </View>
