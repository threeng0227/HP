...
export default class GiftCardHasSent extends Component {
  constructor(props ){
    super(props);
    this.state={
      switch1Value:false,
    ...
    return (
      <Container >
        ...
        <Image style={{height:85,width:85}}
            source={require('../Appointments/images/GiftDola.png')} 
                />
        </View>
        <View style={{ justifyContent: 'center',alignItems: 'center',flex:1,width: 350, height: 50, }} >
        <Text style={{fontSize:21,color:'skyblue'}}>Gift card has been sent !</Text>
        </View>
        <View style={{ justifyContent: 'flex-start',alignItems: 'center',flex:1,width: 350, height: 50, }} >
        <Text style={{fontSize:24,color:'red',fontWeight:'bold'}}>- $ 50.00</Text>
        </View>
        <View style={{ justifyContent: 'flex-start',alignItems: 'center',flex:1,width: 350, height: 50, }} >
        <Text style={{color:'black'}}>You've successfully sent the gift card to</Text>
        ...
        <View style={{justifyContent: 'center',alignItems: 'center',margin:'4%',borderWidth:1,width:300,borderColor:'#EEEEEE',flexDirection:'row',height:40}}>
             ...
             <Text style={{fontSize:20,color:'green',fontWeight:'bold',flex:1,marginBottom:'7%',marginRight:'-25%'}}>$ 714.00</Text>
        </View>
        
        </View>
        <View style={{justifyContent: 'center',alignItems: 'center',flex:1,width: 350, height: 50, }} >
            <Button  style={site.btn}
             onPress={()=>{this.props.navigation.navigate('P2P')}}><Text style={site.btn1}
           > Done </Text></Button> 
        </View>
      </View>
