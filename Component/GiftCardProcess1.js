...
import { Container, Header, Left, Body, Footer, Button, Icon, Title,FooterTab, Content,Right,Input,SearchBar,Tabs, Tab, CheckBox} from 'native-base';
import { TextInput } from 'react-native-gesture-handler';
import Ionicons from 'react-native-vector-icons/Ionicons';
import Ic from 'react-native-vector-icons/FontAwesome';
import Icons from 'react-native-vector-icons/FontAwesome5';

export default class GiftCardProcess1 extends Component {
  constructor(){
    super();
    this.state={
      check:true,
    ...
    return (
      <Container >
        ...
        <View style={{flex:1,flexDirection:'column'}}> 
         <View style={{height:320,marginLeft:'4%',marginRight:'4%',marginTop:'4%',borderRadius:4,borderWidth:0.5,borderColor:'#EEEEEE',paddingTop:'5%',padding:'3%'}}>
