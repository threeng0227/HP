...
import { Container, Header, Left, Body, Footer, Button, Right,FooterTab, Badge} from 'native-base';
import Ionicons from 'react-native-vector-icons/Ionicons';
import Ic from 'react-native-vector-icons/FontAwesome';
import Icons from 'react-native-vector-icons/FontAwesome5';
export default class P2PGifttbao extends React.Component{
    render (){
        return(
            <Container >
        ...
        <View style={{flex: 1,width: 360, }} >
            <Button  style={{  backgroundColor: 'white',flex:1,marginRight:'3%',borderRadius:5,borderColor:'#EEEEEE' ,marginLeft:'3%',marginTop:'3%',justifyContent:'center',alignItems:'center'}}>
        ...
        <View style={{flex: 1,width: 360, }} >
        <Button  style={{backgroundColor: 'white',flex:1,margin:'3%',borderRadius:5,borderColor:'#EEEEEE' ,justifyContent:'center',alignItems:'center'}}>
                  <View style={{flex:1,justifyContent:'center',alignItems:'center'}}><Image 
