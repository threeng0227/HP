...
export default class Tranfer300 extends Component {
  constructor(props ){
    super(props);
    this.state={
      switch1Value:false,
  ...
  render() {
    return (
      <Container >
        ...
        <Text style={{fontSize:24,color:'red',fontWeight:'bold'}}>- $ 300.00</Text>
        </View>
        <View style={{ justifyContent: 'flex-start',alignItems: 'center',flex:1,width: 350, height: 50, }} >
        <Text style={{color:'black'}}>You've successfully transferred money to</Text>
        <Text style={{fontSize:20,color:'skyblue',fontWeight:'bold',marginTop:'3%'}}>**** **** **** **** 5565</Text>
        </View>
        <View style={{ justifyContent: 'flex-start',alignItems: 'center',flex:1,width: 350, height: 50}} >
        <View style={{justifyContent: 'center',alignItems: 'center',margin:'4%',borderWidth:1,width:300,borderColor:'#EEEEEE',flexDirection:'row',height:40}}>
             ...
             <Text style={{fontSize:20,color:'green',fontWeight:'bold',flex:1,marginBottom:'7%',marginRight:'-25%'}}>$ 464.00</Text>
        </View>
