...
import { Container,Header, Content,Button, Fab, Body,Right,Left,Badge, View} from 'native-base';
           ...
           <Ionicons name="md-menu" size={25}></Ionicons>
             ...
             <Content  >
                 ...
                 <View style={{backgroundColor:'#baffff'}}>
                    ...
                    <Text style={{fontSize:20,color:'#42a5f5', fontWeight:'bold'}}> Harmony Salon</Text>
                       ...
                       <Body></Body> 
                       <Right style={{marginRight:'2%',fontWeight:"bold"}}><Text  style={{fontWeight:'bold'}}>Confirmed</Text></Right>
            ...
            <View style={{backgroundColor:'#f5f5f5',marginBottom:10}}>
             ...
             <Fab 
                ...
                style={{width:150,borderRadius:3,backgroundColor:'#0764b0'}}
