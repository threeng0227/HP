...
export default class BookProcess3  extends Component{
        ...
        return(
           ...
           <Ionicons name="md-menu" size={25}></Ionicons>
             ...
             <View style={{flexDirection:'column',marginRight:'1%',marginLeft:'1%',marginTop:10}}> 
                ...
                <View style={{flexDirection:'row',fontWeight:'bold',marginBottom:8}}>
                 <Text style={{fontSize:32,fontWeight:'bold'}}>Review Appointments</Text>
                 </View>
                <View style={{flexDirection:'row',fontWeight:'bold',marginBottom:8}}> 
                 <Text  style={{fontWeight:'bold'}}>Salon: </Text>
                 <Text>Hamony Spa</Text></View>
                <View style={{flexDirection:'row',fontWeight:'bold',marginBottom:8}}>
                    <Text style={{fontWeight:'bold'}}>Date/Time: </Text>
                    <Text>5 jan 2019 / 8:00 AM - 11:00 AM </Text></View>  
                
             </View>  
             <View style={{flexDirection:'row',marginRight:'1%',marginLeft:'1%',marginBottom:10}}> 
             <Left style={{flexDirection:'row'}}>
                 <Text  style={{fontWeight:'bold'}}>Stylist: </Text><Text>Ronaldo</Text>
             </Left>
                   <Right  >
                       <View style={{flexDirection:'row'}}>
                       <Text>Estimate wating time: </Text>
             ...
             <View style={{ backgroundColor: "white", height: 60,  alignItems: 'center', flexDirection: "row" }}>
                   ...
                   <View style={{justifyContent: "center", alignItems: 'center', flexDirection: "row",flex:1 }}>
                    <Button style={{ width:110,borderRadius:3,height:50,
                           ...
                           }} onPress={()=>{this.props.navigation.navigate('AppointmentComfirm')}}>
