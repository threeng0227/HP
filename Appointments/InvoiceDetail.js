           ...
           <Ionicons name="md-menu" size={25}></Ionicons>
            ...
            {/* Modal */}
               ...
               onBackButtonPress={() => this.setState({ isModalVisible: false })}>
                   ...
                   <Left></Left>
                    ...
                    <View style={{flexDirection:'column',width:'90%'}}>
                        ...
                        alignItems:'center',flexDirection:'row',borderWidth:1,width:'23%'}}><Text style={{color:'#0764b0',fontSize:15}}>15 %</Text></Button>
                         <Button style={{borderRadius:2,borderColor:'#0764b0',backgroundColor:'white',justifyContent:'center',
                        alignItems:'center',flexDirection:'row',borderWidth:1,width:'23%',marginLeft:'2%',backgroundColor:'#0764b0'}}><Text style={{color:'white',fontSize:15}}>18 %</Text></Button>
                        <Button style={{borderRadius:2,borderColor:'#0764b0',backgroundColor:'white',justifyContent:'center',
                ...
                <Button  style={{width:'50%',borderRadius:3,justifyContent:"center",alignItems:'center',backgroundColor:'#0764b0',flexDirection:'column'}}
